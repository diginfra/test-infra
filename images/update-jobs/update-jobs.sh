...
cd /home/prow/go/src/github.com/diginfra/test-infra/prow/update-jobs
...
bin/update-jobs --kubeconfig $KUBECONFIG --jobs-config-path /home/prow/go/src/github.com/diginfra/test-infra/config/jobs
